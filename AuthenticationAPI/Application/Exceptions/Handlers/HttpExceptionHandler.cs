using AuthenticationAPI.Application.Exceptions.Extensions;
using AuthenticationAPI.Application.Exceptions.HttpProblemDetails;
using AuthenticationAPI.Application.Exceptions.Types;

namespace AuthenticationAPI.Application.Exceptions.Handlers;
